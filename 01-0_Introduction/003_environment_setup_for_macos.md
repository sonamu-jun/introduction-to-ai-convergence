...
```bash
cd ~
git clone https://github.com/sonamu-jun/introduction-to-ai-convergence.git
cd introduction-to-ai-convergence
```

For later updates, use the GitHub guide: [Download and update the course files](https://github.com/sonamu-jun/introduction-to-ai-convergence/blob/main/01-0_Introduction/004_github_download_and_update.md).

## 4. Course Environment Creation

This creates a separate Python workspace for this course. Run these commands inside the `introduction-to-ai-convergence` folder.
...
Open VS Code, choose `File` then `Open Folder`, and select `introduction-to-ai-convergence`.
